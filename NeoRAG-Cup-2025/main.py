...
from metrics_rag import recall_k
...
# print(recall_k("CLB_PROPTIT.csv", "train_data_proptit.xlsx", embedding, vector_db, k=5)) # đặt là True nếu là tập train, False là tập test
